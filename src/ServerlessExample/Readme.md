...
```
    cd "JE.RestaurantAvailabilityNotifier"
    dotnet restore
```

Execute unit tests
```
    cd "JE.RestaurantAvailabilityNotifier/test/JE.RestaurantAvailabilityNotifier.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "JE.RestaurantAvailabilityNotifier/src/JE.RestaurantAvailabilityNotifier"
